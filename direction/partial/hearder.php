...
<html lang="en">
    ...
    <head>
        ...
        <link href="../asset/vendors/lineprogressbar/jquery.lineProgressbar.min.css" rel="stylesheet">
            ...
            <div class="site-width">
                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>                  
                        <ul>
                            <li><a href="index.php"><i class="ti-microsoft"></i> accueil</a></li>
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-home mr-1"></i> Gestion colis</a>                  
                        <ul>
                            ...
                            <li ><a href="reception_colis.php"><i class="fas fa-truck"></i> Reception colis  <span class="badge badge-pill badge-danger ml-auto">6</span></a> </li>
                            
                           
                        </ul>
                    </li>

                    <!-- gestion personnel et bus -->
                    <li class="dropdown"><a href="#"><i class="ti-view-grid mr-1"></i> Gestion bus et personnel</a>                  
                        <ul>
                            <li><a href="gestion_bus.php"><i class="fas fa-truck"></i> gestion Bus</a></li>
                            <li><a href="user.php"><i class="icon-user"></i> Utilisateur</a></li>
