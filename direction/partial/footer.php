 ...
 <footer class="site-footer">
        ...
        <!-- END: APP JS-->
 <!-- START: Page JS-->
 <script src="../asset/js/app.filemanager.js"></script>
        <!-- END: Page JS-->
 ...
 <script src="../asset/js/sweetalert.script.js"></script>       
        ...
        <script  src="../asset/vendors/lineprogressbar/jquery.lineProgressbar.js"></script>
        <script  src="../asset/vendors/lineprogressbar/jquery.barfiller.js"></script>
        <!-- END: Page Vendor JS-->
